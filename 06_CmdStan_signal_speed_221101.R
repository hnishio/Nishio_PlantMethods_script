...
out <- "06_CmdStan_signal_speed_221101"
...
ggsave(paste0(out, "/individual_lm_dist_start.pdf"),
...
suppressWarnings(ggsave(paste0(out, "/individual_lm_start_dist.pdf"),
                        g, height = 110, width = 50*3, units = "mm"))
...
ggsave(paste0(out, "individual_predicted_starttime.pdf"),
       g, height = 35, width = 40, units = "mm")
...
ggsave(paste0(out, "individual_signalingtime_starttime.pdf"),
